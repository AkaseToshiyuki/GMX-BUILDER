...
<p><a href="GMXBUILDER_USER_MANUAL_V1.0.2.md">English</a> · <strong>简体中文</strong></p>

| 项目 | 内容 |
|---|---|
| 文档版本 | V1.0.2 |
| 适用软件 | GMXBUILDER v0.9.0 或更高版本 |
| 编写人 | Haochen Yang |
| 发布日期 | 2026-08-14 |
| 文档状态 | 正式发布 |
...
`prebuilt-assets install` 会依次校验归档 SHA-256、严格库 schema，并确认归档内
