...
| 文档版本 | 日期 | 变更内容 | 编写人 |
|---|---|---|---|
| V1.0.4 | 2026-08-17 | 记录自动管理的 GROMACS 与 GAFF2 运行时，修正执行硬件、离子放置和显式脂质数膜预览契约，并使安装、网页、CLI、API 和故障排查说明与 GMXBUILDER v0.9.19 同步 | Haochen Yang |
...
- 定期清理过期任务并审查依赖、预构建资产校验状态及第三方许可证。
