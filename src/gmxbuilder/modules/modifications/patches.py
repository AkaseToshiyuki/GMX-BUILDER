...
_LYSINE_METHYL_MONO = Patch(
    name="KME",
    description="Lysine mono-methylation — adds methyl to ε-amine",
    target_residues=["LYS"],
    product_name="MLZ",
    ...
    bond_to="NZ",
    mass_shift=14.03,
    formula_addition="CH2",
    requires_itp="kme.itp",
)

_LYSINE_METHYL_DI = Patch(
    name="KME2",
    description="Lysine di-methylation — two methyls on ε-amine",
    target_residues=["LYS"],
    product_name="MLY",
    charge_shift=0,
    added_atoms=[
    ...
    requires_itp="kme2.itp",
)

_LYSINE_METHYL_TRI = Patch(
    name="KME3",
    description="Lysine tri-methylation — trimethylammonium (+1 permanent)",
    target_residues=["LYS"],
    product_name="M3L",
    ...
    bond_to="NZ",
    mass_shift=42.08,
    formula_addition="C3H6",
    requires_itp="kme3.itp",
)

_ARGININE_METHYL_MONO = Patch(
    name="RME",
    description="Arginine mono-methylation — Nω-methyl-arginine",
    target_residues=["ARG"],
    product_name="RME",
    ...
    mass_shift=14.03,
    formula_addition="CH2",
    requires_itp="rme.itp",
)

_ARGININE_METHYL_SYM = Patch(
    name="RME2",
    description="Arginine symmetric di-methylation — both Nω methylated",
    target_residues=["ARG"],
    product_name="2MR",
    charge_shift=0,
    added_atoms=[
...
_CYSTEINE_SULFENIC = Patch(
    name="CSO",
    description="Cysteine oxidation to protonated sulfenic acid (-SOH)",
    target_residues=["CYS"],
    product_name="CSO",
    charge_shift=0,
    ...
    mass_shift=16.00,
    formula_addition="O",
    requires_itp="cso.itp",
)

_CYSTEINE_SULFINIC = Patch(
    name="CSD",
    description="Cysteine oxidation to sulfinic acid (-SO₂H)",
    target_residues=["CYS"],
    product_name="CSD",
    charge_shift=-1,
    added_atoms=[
    ...
    mass_shift=32.00,
    formula_addition="O2",
    requires_itp="csd.itp",
)

_CYSTEINE_SULFENATE = Patch(
    name="CSX",
    description="Cysteine oxidation to deprotonated sulfenic acid (-SO⁻)",
    target_residues=["CYS"],
    product_name="CSX",
    charge_shift=-1,
    added_atoms=[PatchAtom("OD", "O")],
    ...
    mass_shift=16.00,
    formula_addition="O",
    requires_itp="csx.itp",
)

_CYSTEINE_NITROSYL = Patch(
    name="CSN",
    description="Cysteine S-nitrosylation (-SNO)",
    target_residues=["CYS"],
    product_name="SNC",
    charge_shift=0,
    added_atoms=[
...
_ASN_DEAMIDATION = Patch(
    name="DEA",
    description="Asparagine deamidation — ASN→ASP (hydrolysis of sidechain amide)",
    target_residues=["ASN"],
    product_name="ASP",
...
_GLN_DEAMIDATION = Patch(
    name="DEG",
    description="Glutamine deamidation — GLN→GLU (hydrolysis of sidechain amide)",
    target_residues=["GLN"],
    product_name="GLU",
...
_NTER_FORMYL = Patch(
    name="FOR",
    description="N-terminal formylation — formyl cap on N-terminus",
    target_residues=["NTER"],
    product_name="FOR",
    charge_shift=0,
    added_atoms=[
        PatchAtom("C", "C"),
    ...
    bond_to="N",
    mass_shift=28.01,
    formula_addition="CHO",
    requires_itp="for.itp",
)

_PYROGLUTAMATE = Patch(
    name="PCA",
    description="Pyroglutamate — N-terminal GLN cyclisation to PCA",
    target_residues=["GLN"],
    product_name="PCA",
    ...
    mass_shift=-17.03,
    formula_addition="",
    requires_itp="pca.itp",
)

_LYSINE_MALONYL = Patch(
    name="MAL",
    description="Lysine malonylation — malonyl group on ε-amine",
    target_residues=["LYS"],
    product_name="MALY",
    ...
    bond_to="NZ",
    mass_shift=86.05,
    formula_addition="C3H2O3",
    requires_itp="mal.itp",
)

_LYSINE_CROTONYL = Patch(
    name="CRO",
    description="Lysine crotonylation — crotonyl group on ε-amine",
    target_residues=["LYS"],
    product_name="CRY",
    ...
    bond_to="NZ",
    mass_shift=68.07,
    formula_addition="C4H4O",
    requires_itp="cro.itp",
)

_LYSINE_BUTYRYL = Patch(
    name="BUT",
    description="Lysine butyrylation — butyryl group on ε-amine",
    target_residues=["LYS"],
    product_name="BLY",
    charge_shift=-1,
    added_atoms=[
    ...
    bond_to="NZ",
    mass_shift=70.09,
    formula_addition="C4H6O",
    requires_itp="but.itp",
)

_LYSINE_PROPIONYL = Patch(
    name="PRO",
    description="Lysine propionylation — propionyl group on ε-amine",
    target_residues=["LYS"],
    product_name="PLY",
    charge_shift=-1,
    added_atoms=[
    ...
    bond_to="NZ",
    mass_shift=56.06,
    formula_addition="C3H4O",
    requires_itp="pro.itp",
)

_LYSINE_GLUTARYL = Patch(
    name="GLR",
    description="Lysine glutarylation — glutaryl group on ε-amine",
    target_residues=["LYS"],
    product_name="GRY",
    charge_shift=-1,
    added_atoms=[
    ...
    bond_to="NZ",
    mass_shift=114.10,
    formula_addition="C5H6O3",
    requires_itp="glr.itp",
)

_O_GLcNAc_SER = Patch(
    name="GCS",
    description="O-GlcNAcylation — single GlcNAc on serine",
    target_residues=["SER"],
    product_name="GCS",
    charge_shift=0,
    added_atoms=[
    ...
    bond_to="OG",
    mass_shift=203.19,
    formula_addition="C8H13NO5",
    requires_itp="glcnac.itp",
)

_O_GLcNAc_THR = Patch(
    name="GCT",
    description="O-GlcNAcylation — single GlcNAc on threonine",
    target_residues=["THR"],
    product_name="GCT",
    charge_shift=0,
...
_TYROSINE_SULFATION = Patch(
    name="TYS",
    description="Tyrosine O-sulfation — sulfate on hydroxyl",
    target_residues=["TYR"],
    product_name="TYS",
    ...
    bond_to="OH",
    mass_shift=80.06,
    formula_addition="SO3",
    requires_itp="tys.itp",
)

_SERINE_ACETYL = Patch(
    name="SAC",
    description="Serine O-acetylation — acetyl on sidechain hydroxyl",
    target_residues=["SER"],
    product_name="OAS",
    charge_shift=0,
    added_atoms=[
    ...
    bond_to="OG",
    mass_shift=42.04,
    formula_addition="C2H2O",
    requires_itp="sac.itp",
)

_CYSTEINE_METHYL = Patch(
    name="SMC",
    description="Cysteine S-methylation — methyl thioether",
    target_residues=["CYS"],
    product_name="SMC",
    charge_shift=0,
    ...
    mass_shift=14.03,
    formula_addition="CH2",
    requires_itp="smc.itp",
)

_CYSTEINE_SULFONIC = Patch(
    name="OCS",
    description="Cysteine oxidation to cysteinesulfonic acid (-SO3−)",
    target_residues=["CYS"],
    product_name="OCS",
    charge_shift=-1,
    added_atoms=[
    ...
    mass_shift=48.00,
    formula_addition="O3",
    requires_itp="ocs.itp",
)

_HYDROXYPROLINE = Patch(
    name="HYP",
    description="trans-4-hydroxy-L-proline (2S,4R)",
    target_residues=["PRO"],
    product_name="HYP",
    charge_shift=0,
...
_HYDROXYLYSINE = Patch(
    name="HYL",
    description="5-hydroxylysine (2S,5R)",
    target_residues=["LYS"],
    product_name="LYZ",
    charge_shift=0,
...
_NITROTYROSINE = Patch(
    name="NIY",
    description="3-nitro-L-tyrosine — meta nitration of the phenolic ring",
    target_residues=["TYR"],
    product_name="NIY",
    charge_shift=0,
    added_atoms=[
    ...
    bond_to="CE1",
    mass_shift=45.00,
    formula_addition="NO2",
    requires_itp="niy.itp",
)

_THREONINE_ACETYL = Patch(
    name="TAC",
    description="Threonine O-acetylation — acetyl on sidechain hydroxyl",
    target_residues=["THR"],
    product_name="TAC",
    charge_shift=0,
    ...
    mass_shift=42.04,
    formula_addition="C2H2O",
    requires_itp="tac.itp",
)

_CYSTEINE_FARNESYL = Patch(
    name="FAR",
    description="Cysteine S-farnesylation — C15 isoprenoid chain",
    target_residues=["CYS"],
    product_name="FAR",
    charge_shift=0,
    added_atoms=[
    ...
    bond_to="SG",
    mass_shift=204.35,
    formula_addition="C15H25",
    requires_itp="far.itp",
)

_CYSTEINE_DISULFIDE = Patch(
    name="CYX",
    description="Disulfide bond formation — paired CYS→CYS bridge",
    target_residues=["CYS"],
    product_name="CYX",
...
_TRYPTOPHAN_OXIDATION = Patch(
    name="WOX",
    description="Tryptophan oxidation — hydroxytryptophan",
    target_residues=["TRP"],
    product_name="WOH",
    charge_shift=0,
    added_atoms=[PatchAtom("OH", "O")],
    ...
    mass_shift=16.00,
    formula_addition="O",
    requires_itp="wox.itp",
)

_GLYCINE_LIPIDATION = Patch(
    name="GPL",
    description="N-palmitoylation on glycine — C16:0 acyl chain",
    target_residues=["GLY"],
    product_name="GPL",
    charge_shift=0,
...
_UNSUPPORTED_REASONS: dict[str, str] = {
    ...
    "RME_ARG": ("No validated native N-omega-monomethylarginine template is bundled"),
    "CYX_CYS": (
...
def patch_capability(patch_id: str, force_field: str | None = None) -> tuple[bool, str]:
    ...
    if patch_id in _NATIVE_TEMPLATE_PATCHES:
        ...
        parent = next(
            (
                rtp.get_residue(name)
                for name in patch.target_residues
...
def effective_patch_charge_shift(patch_id: str, force_field: str | None = None) -> int:
    ...
    if product is None or target is None:
        return patch.charge_shift
    delta = sum(atom[2] for atom in product["atoms"]) - sum(atom[2] for atom in target["atoms"])
    rounded = round(delta)
    if abs(delta - rounded) > 1e-3:
        raise ValueError(f"Non-integral charge shift for {patch_id} in {force_field}: {delta:.6f}")
    return int(rounded)
